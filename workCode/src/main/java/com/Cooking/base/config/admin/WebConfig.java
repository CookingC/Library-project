package com.Cooking.base.config.admin;
/**
 * 用来配置拦截器的配置类
 */
...
import com.Cooking.base.admin.interceptor.AuthorityInterceptor;
import com.Cooking.base.admin.interceptor.LoginInterceptor;
import com.Cooking.base.constant.RuntimeConstant;
@Configuration
